...
with st.form("survey_form"):
    ...
    st.write("How many hours do you spend on your phone per day?")
    sunday = st.number_input("Sunday", min_value=0.0, max_value=24.0, step=0.5)
    monday = st.number_input("Monday", min_value=0.0, max_value=24.0, step=0.5)
    tuesday = st.number_input("Tuesday", min_value=0.0, max_value=24.0, step=0.5)
    wednesday = st.number_input("Wednesday", min_value=0.0, max_value=24.0, step=0.5)
    thursday = st.number_input("Thursday", min_value=0.0, max_value=24.0, step=0.5)
    friday = st.number_input("Friday", min_value=0.0, max_value=24.0, step=0.5)
    saturday = st.number_input("Saturday", min_value=0.0, max_value=24.0, step=0.5)

    category_input = "Phone Usage"
